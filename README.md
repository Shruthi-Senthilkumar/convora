...
Because using someone else's turn-detector teaches you nothing about *how* turn detection actually works. This project exists to open the black box: real ASR integration, real semantic judgment calls, real signal fusion, real interruption handling — engineered, measured, and honestly reported, gap included.
